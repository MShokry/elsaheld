...
const OrderHistory: React.FC<OrderHistoryProps> = () => {
  ...
  const data: ListRowItemProps[] = Orders.results?.map((item) => {
    ...
    return {
      ...
      // ),
      leftIcon: (
        <Image source={{ uri: `${baseImages}${RestaurantPhoto}` }} style={styles.profileAvatar} />
      ),
    };
  }) || [];
